    ...
    <div className='flex items-center justify-between py-4'>
        ...
        <div>
            ...
            <div className='flex items-center gap-2 sm:gap-3'>
                <button  onClick={()=> navigate('/buy')} className='flex items-center gap-2 bg-blue-100 px-4 sm:px-6 py1.5 sm:py-3 rounded-full hover:scale-105 transition-all duration-700'>
